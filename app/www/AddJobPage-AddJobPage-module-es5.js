...
var AddJobPagePageModule = /** @class */ (function () {
    function AddJobPagePageModule() {
    }
...
var AddJobPage = /** @class */ (function () {
    function AddJobPage(Apperyio, $aio_mappingHelper, $aio_changeDetector) {
    ...
    AddJobPage.prototype.__getMapping = function (_currentItem, property, defaultValue, isVariable, isSelected) {
        return this.$aio_mappingHelper.getMapping(this.mappingData, _currentItem, property, defaultValue, isVariable, isSelected);
    };
    AddJobPage.prototype.button3Click__j_20 = function (event, currentItem) {
    ...
    AddJobPage.prototype.invokeService_createJob = function (cb) {
        var _this = this;
        this.Apperyio.getService("UserDB_UserProfile_create_service").then(function (service) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
    ...
    AddJobPage.ctorParameters = function () { return [
...
//# sourceMappingURL=AddJobPage-AddJobPage-module-es5.js.map