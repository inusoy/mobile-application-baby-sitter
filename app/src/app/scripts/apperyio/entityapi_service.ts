...
import { models } from "../models";
    ...
    interface NoModelErr {name: string, message: string}
    ...
    var clone = _.clone,
        ...
        TypeNotFoundError = function(message) {return {"name": "TypeNotFoundError", message: message} },
        NoModelError = function(message) {return {"name": "NoModelError", message: message} },
    ...
    export class EntityApiService {
        ...
        get(name, defaults?, default_undefined?, skip_empty_objects?) {
            ...
            return _.cloneDeepWith( result, function( v ) {
                if ( isArray( v ) ) {
                    var r = v.concat();
            ...
            if ( typeof this._types[ hashName ] == "function" ) {
                ...
                try {
                    ...
                    if ( e instanceof NoModelError ) {
                        throw TypeNotFoundError( (<NoModelErr>e).message );
                    }
                    throw e;
                }
                return this._types[ hashName ].apply( this, Array.prototype.slice.call( arguments, 1 ) );
