/**
 * Module initializes rest service UserDB_UserProfile_create_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class UserDB_UserProfile_create_service {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "post",
            headers: this.entityAPI.get("UserDB_UserProfile_create_service.request.headers"),
            params: this.entityAPI.get("UserDB_UserProfile_create_service.request.query"),
            data: this.entityAPI.get("UserDB_UserProfile_create_service.request.body", reqOpts.data, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "UserDB_UserProfile_create_service"
            }
        };
...
*/
export {
    UserDB_UserProfile_create_service as ExportedClass
};