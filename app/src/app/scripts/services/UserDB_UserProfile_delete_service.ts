/**
 * Module initializes rest service UserDB_UserProfile_delete_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class UserDB_UserProfile_delete_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/db/collections/UserProfile/{_id}",
            method: "delete",
            headers: this.entityAPI.get("UserDB_UserProfile_delete_service.request.headers"),
            params: this.entityAPI.get("UserDB_UserProfile_delete_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "UserDB_UserProfile_delete_service"
            }
        };
...
*/
export {
    UserDB_UserProfile_delete_service as ExportedClass
};