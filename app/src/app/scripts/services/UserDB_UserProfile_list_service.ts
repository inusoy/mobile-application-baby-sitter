/**
 * Module initializes rest service UserDB_UserProfile_list_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class UserDB_UserProfile_list_service {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("UserDB_UserProfile_list_service.request.headers"),
            params: this.entityAPI.get("UserDB_UserProfile_list_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "UserDB_UserProfile_list_service"
            }
        };
...
*/
export {
    UserDB_UserProfile_list_service as ExportedClass
};